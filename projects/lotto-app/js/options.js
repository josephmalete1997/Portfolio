...
const changeColor = (...index) => {
  ...
  for (let i = 0; i < arr.length; i++) {
    elements.optionsList[arr[i]].style.background = "var(--gradient-blue)";
    elements.optionsList[arr[i]].style.color = "rgb(183, 183, 255)";
  }
};
